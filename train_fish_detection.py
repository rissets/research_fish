#!/usr/bin/env python3
"""
Script untuk training YOLO object detection model dengan fish dataset
Author: AI Assistant
Date: 2025-09-13
"""
...
class FishDetectionTrainer:
    ...
    def train(self, data_path, epochs=100, imgsz=640, batch_size=16, 
        ...
        print(f"\n🚀 Starting object detection training with parameters:")
    ...
    def test_inference(self, model_path, image_path, save_dir="./inference_results"):
        ...
        for img_path in images:
            ...
            for i, result in enumerate(results):
                output_path = save_dir / f"{Path(img_path).stem}_detection.jpg"
...
def main():
    parser = argparse.ArgumentParser(description='Fish Object Detection Training with YOLO')
    parser.add_argument('--data', type=str, required=True, 
                       help='Path to dataset yaml file or dataset directory')
    parser.add_argument('--model', type=str, default='yolov8n.pt',
                       help='Model to use (default: yolov8n.pt for detection)')
    ...
    print("🐟 Fish Object Detection Training with YOLO")
    print("=" * 60)
    
    # Initialize trainer
    trainer = FishDetectionTrainer(model_name=args.model, device=args.device)
    ...
    print(f"\n🎉 Object detection training pipeline completed!")
    if best_model_path:
